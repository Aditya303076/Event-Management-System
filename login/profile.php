  ...
  <div class="card">
    <div class="additional">
      <div class="user-card">
          ...
          <?php
          echo '<svg width="110" height="110" viewBox="0 0 250 250" class="center">
          <rect x="5%" y="5%" width="90%" height="90%" rx="20%" fill="transparent" stroke="white" stroke-width="10"/>
          <text x="50%" y="50%" font-size="100" dominant-baseline="middle" text-anchor="middle" fill="white">
              '. strtoupper(substr($_SESSION["firstname"], 0, 1)) .'
          </text>
          </svg>';
          ?>
          <title id="title"><?php echo $_SESSION["firstname"] ;?></title>
          <desc id="desc"></desc>
          <style>
            .skin { fill: #eab38f; }
            .eyes { fill: #1f1f1f; }
    ...
    <div class="general">
      ...
      <p style="margin-top: 1rem">We are happy to having you as a customer, We will always there for your help !</p>
      <span class="more">Mouse over the card for your details</span>
    </div>
  </div>
